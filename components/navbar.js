...
const navbarHtml = `
  <header class="fixed inset-x-0 top-0 z-50">
    <div id="nav-inner" class="transition-colors duration-300">
      <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <a href="index.html" class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-full bg-medblue flex items-center justify-center text-white font-bold">M</div>
        ...
        <div class="flex items-center gap-3">
          ...
          <button id="mobile-toggle" class="md:hidden p-2 rounded border"><i data-feather="menu"></i></button>
        </div>
      </div>
